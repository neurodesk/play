...
_There is also an interactive example of this tool. You can visit the example notebook [here](https://neurodesk.org/example-notebooks/functional_imaging/fmriprep.html)._ 
...
![launch_neurodesk](/static/learning-resources/tutorials/functional_imaging/fmriprep/launch_neurodesk.png 'launch_neurodesk') <!-- ![filename without extension](/static/learning-resources/tutorials/functional_imaging/subfolder_name/filename.png '[filename without extension')  -->

## Open fmriprep 

Now you're in Neurodesk, use the menus to first open the neurodesk options

![neurodesk_menu](/static/learning-resources/tutorials/functional_imaging/fmriprep/neurodesk_menu.png 'neurodesk_menu') <!-- ![filename without extension](/static/learning-resources/tutorials/functional_imaging/subfolder_name/filename.png '[filename without extension')  -->

and then select fMRIPrep. Note that the latest version will be the lowest on the dropdown list:

![open_fmriprep](/static/learning-resources/tutorials/functional_imaging/fmriprep/open_fmriprep.png 'open_fmriprep') <!-- ![filename without extension](/static/learning-resources/tutorials/functional_imaging/subfolder_name/filename.png '[filename without extension')  -->

This will open a terminal window where fMRIPrep is ready and waiting at your fingertips - woohoo!

![fmriprep_bash](/static/learning-resources/tutorials/functional_imaging/fmriprep/fmriprep_bash.png 'fmriprep_bash') <!-- ![filename without extension](/static/learning-resources/tutorials/functional_imaging/subfolder_name/filename.png '[filename without extension')  -->
