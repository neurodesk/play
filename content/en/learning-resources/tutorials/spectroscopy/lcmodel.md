...
- /tutorials-examples/tutorials/spectroscopy/lcmodel
...
_There is also an interactive example of this tool. You can visit the example notebook [here](https://neurodesk.org/example-notebooks/spectroscopy/lcmodel.html)._ 
