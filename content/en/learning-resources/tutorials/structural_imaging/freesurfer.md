...
- /tutorials-examples/tutorials/structural_imaging/freesurfer
...
_There is also an interactive example of this tool. You can visit the example notebook [here](https://neurodesk.org/example-notebooks/structural_imaging/freesurfer.html)._ 
